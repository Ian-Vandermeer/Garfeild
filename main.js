...
function draw() {
    ...
    for (i = 0; i < xbucks.length; i++) {
        ...
        if (xbucks[i] + 20 > cnv.width || xbucks[i] + 100 < 0 || ybucks[i] + 100 < 0 || ybucks[i] + 20 > cnv.height) {
            xbucks.splice(i, 1)
            ybucks.splice(i, 1)
            wbucks.splice(i, 1)
            hbucks.splice(i, 1)
    ...
    // if (moneyTotal >= 1000000 && moneyTotal < 1000000000) {
    //     document.getElementById('totalmonie').innerHTML = 'Total money: ' + (moneyTotal / 1000000).toFixed(3) + "M";
    // }
    // if (moneyTotal >= 1000000000 && moneyTotal < 1000000000000) {
    //     document.getElementById('totalmonie').innerHTML = 'Total money: ' + (moneyTotal / 1000000000).toFixed(3) + "B";
    // }
    // if (moneyTotal >= 1000000000000 && moneyTotal < 1000000000000000) {
    //     document.getElementById('totalmonie').innerHTML = 'Total money: ' + (moneyTotal / 1000000000).toFixed(3) + "T";
    // }
...
document.getElementById('garfield').addEventListener('click', addmoney);
...
function addMandBandT(aValue, element, displayText) {
    ...
    if (aValue >= 1000000000000 && aValue < 1000000000000000) {
        document.getElementById(element).innerHTML = displayText + (Number(aValue) / 1000000000).toFixed(3) + "T";
    } 
...
function addmoney() {
    ...
    xbucks.push(randomDec(250, 400));
    ybucks.push(150);
    wbucks.push(randomInt(70, 100));
    hbucks.push(randomInt(70, 100));
    xspdbucks.push(randomDec(-5, 5));
    yspdbucks.push(randomDec(-5, 5));
}
